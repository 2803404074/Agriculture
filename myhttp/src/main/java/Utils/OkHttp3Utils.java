...
public class OkHttp3Utils {
    ...
    public void doGet(String url,String token, Callback callback) {
        ...
        //创建Request
        Request request = new Request.Builder().url(requestUrl).addHeader("Authentication","dGVybWluYWwtYXBw").addHeader("token",token).build();
        //得到Call对象
    ...
    public void doGet2(String url, Callback callback) {
        ...
        String requestUrl = BASE_PATH + url;
        //创建Request
        Request request = new Request.Builder().url(requestUrl).addHeader("Authentication","dGVybWluYWwtYXBw").build();
        //得到Call对象
        Call call = okHttpClient.newCall(request);
        //执行异步请求
        call.enqueue(callback);
    ...
    public void doPost(String url, Map<String, String> params, Callback callback) {
        ...
        //创建Request
        Request request = new Request.Builder().url(requestUrl).addHeader("Authentication","dGVybWluYWwtYXBw").post(builder.build()).build();
    ...
    public void upLoadFile(String url, Map<String, Object> map, File file, Callback callback) {
        ...
        Request request = new Request.Builder().url(requestUrl).addHeader("Authentication","dGVybWluYWwtYXBw").post(requestBody.build()).build();
            ...
            for (Map.Entry entry : map.entrySet()) {
                if(entry.getValue() instanceof File){
                    ...
                    for (int i=0;i<list.size();i++){
                        RequestBody body = RequestBody.create(MediaType.parse("*"), list.get(i));
    ...
    public  void doPostJson(String url, String jsonParams, Callback callback) {
        ...
        Request request = new Request.Builder().url(path).addHeader("Authentication","dGVybWluYWwtYXBw").post(requestBody).build();
     ...
     * @param callback
     */
    public  void doPostJson2(String url, String jsonParams,String token, Callback callback) {
        RequestBody requestBody = RequestBody.create(MediaType.parse("application/json; charset=utf-8"), jsonParams);
        //拼接地址
        String path = BASE_PATH+url;
